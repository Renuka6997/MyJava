...
public class Marker implements Cloneable { // Marker Interface
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		m.cost = 22;
		System.out.println("m cost = " + m.cost);
		System.out.println("m1.cost = " + m1.cost);

		Marker m2 = new Marker(100, 5.5);
		Object o = m2.clone();
		Marker m3 = (Marker) o;
		System.out.println("**********************");
